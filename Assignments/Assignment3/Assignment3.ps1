...
# For example, you should see PS /home/kali/CSCI1411-Fall2025/Assignments/Assignment3>         #       
# One way is to run "cd ./CSCI1411-Fall2025/Assignments/Assignment3" before starting  #
# the assignment                                                                                           #
...
## Example of Function: logSearcher -dir "./Data/*" -text "SAMPLE" -showLogs $True
...
## A helper function has been provided to you already called incidentCost. That you can use here.
